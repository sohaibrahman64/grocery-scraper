...
class SingleProductCategoryScraper:
    def __init__(self, product_urls_per_category):
        self.page = None
        self.soup = None
        self.product_urls_per_category = product_urls_per_category
        self.products = []
        self.products_per_category_dict = {}

    def scrape_products(self):

        for index in range(len(self.product_urls_per_category)):
            single_product_per_category_dict = self.product_urls_per_category[index]
            product_url = single_product_per_category_dict['product_url']
            category_name = single_product_per_category_dict['category_name']
            single_product = self.scrape_single_product(product_url, category_name)
            # print(single_product)
            self.products.append(single_product)
            self.products_per_category_dict[category_name] = self.products
        # print(self.products)

    def scrape_products_new(self):
    ...
    def scrape_products_new_new(self):
        previous_category_name = ''
        category_id = 0
        for index in range(len(self.product_urls_per_category)):
            single_product_per_category_dict = self.product_urls_per_category[index]
            ...
            if previous_category_name != category_name:
                category_id += 1
            single_product = self.scrape_single_product(product_url, category_name, category_id)
            # print(single_product)
            self.products.append(single_product)
            # self.products_per_category_dict[category_name] = self.products
            previous_category_name = category_name
    ...
    def scrape_single_product(self, product_url, category_name, category_id):
        # print(product_url)
        ...
        if tab_content.h2:
            ...
            title = self.soup.find(class_="heading-title").get_text()

        single_product['category_id'] = category_id
        ...
        # single_product['category_name'] = category_name
    ...
    def get_products(self):
        return self.products_per_category_dict
